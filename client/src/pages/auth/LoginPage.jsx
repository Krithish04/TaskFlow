          ...
          <div className="form-section" style={{ gap: 14 }}>
            <div className="field">
              ...
              <input
                ...
                value={lForm.email}
                onChange={(e) =>
                  setLForm((f) => ({ ...f, email: e.target.value }))
                }
            ...
            <div className="field">
              ...
              <input
                ...
                onChange={(e) =>
                  setLForm((f) => ({ ...f, password: e.target.value }))
                }
                placeholder="••••••••"
                onKeyDown={(e) => e.key === "Enter" && handleLogin()}
              />
          ...
          <div className="form-section" style={{ gap: 14 }}>
            <div className="field">
              ...
              <input
                ...
                value={rForm.name}
                onChange={(e) =>
                  setRForm((f) => ({ ...f, name: e.target.value }))
                }
            ...
            <div className="field">
              ...
              <input
                ...
                value={rForm.email}
                onChange={(e) =>
                  setRForm((f) => ({ ...f, email: e.target.value }))
                }
            ...
            <div className="field">
              ...
              <input
                ...
                onChange={(e) =>
                  setRForm((f) => ({ ...f, password: e.target.value }))
                }
